...
import { LibraryGrid, ClearLibraryButton } from "./Library";
    ...
    <div className="page prose-page">
      ...
      {page === "about" ? (
        ...
        <>
          ...
          <p>
            A game player is only requested after you allow third-party games in
            Privacy settings and choose to play. Distribution partners receive
            your network address and may use their own cookies and advertising
            technologies. Their own privacy and advertising choices remain
            available inside the player.
          </p>
          <h2>Your choices</h2>
          <p>
          ...
          <p>
            ...
            controls whether the external player loads and does not replace the
            game provider’s own privacy choices. If storage is blocked, the
            choice lasts only until the page is reloaded. Closing the player
        ...
        <>
          ...
          <p>
            Optional Google Analytics is disabled until you allow visit
            analytics in Privacy settings. The choice uses sessionStorage under
